...
const map = new Map([
  ['close', require('v9u-smb2/lib/structures/close')],
  ['constants', require('v9u-smb2/lib/structures/constants')],
  ['create', require('v9u-smb2/lib/structures/create')],
  ['negotiate', require('v9u-smb2/lib/structures/negotiate')],
  ['query_directory', require('v9u-smb2/lib/structures/query_directory')],
  ['read', require('v9u-smb2/lib/structures/read')],
  ['session_setup', require('v9u-smb2/lib/structures/session_setup')],
  ['set_info', require('v9u-smb2/lib/structures/set_info')],
  ['tree_connect', require('v9u-smb2/lib/structures/tree_connect')],
  ['write', require('v9u-smb2/lib/structures/write')],
]);
proto.setHeaders = function(obj) {
  for (var key in obj) {
    this.headers[key] = obj[key];
  }
  this.structure = map.get(this.headers['Command'].toLowerCase());
...
function readHeaders(message, buffer) {
  ...
  // console.log("message.headers['Command'].toLowerCase()):",message.headers['Command'].toLowerCase())
  message.structure = map.get(message.headers['Command'].toLowerCase());
}
